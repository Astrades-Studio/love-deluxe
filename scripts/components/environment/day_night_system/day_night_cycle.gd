...
@export var sun_color: Gradient = preload("res://scripts/components/environment/day_night_system/sun_gradients/normal/normal_sun_color_gradient.tres")
@export var sun_intensity: Curve = preload("res://scripts/components/environment/day_night_system/sun_gradients/normal/normal_sun_intensity_curve.tres")
...
@export var moon_color: Gradient = preload("res://scripts/components/environment/day_night_system/moon_gradients/normal/normal_moon_color_gradient.tres")
@export var moon_intensity: Curve = preload("res://scripts/components/environment/day_night_system/moon_gradients/normal/normal_moon_intensity_curve.tres")
...
@export var available_day_panoramas: Array[Texture2D] = [
	preload("res://scripts/components/environment/day_night_system/skybox/panoramas/dawn.png"),
	preload("res://scripts/components/environment/day_night_system/skybox/panoramas/day.png")
]
@export var available_dusk_panoramas: Array[Texture2D] = [
	preload("res://scripts/components/environment/day_night_system/skybox/panoramas/dusk.png"),
]

@export var overcast_panorama: Texture2D = preload("res://scripts/components/environment/day_night_system/skybox/panoramas/overcast.png")
@export var sky_top_color: Gradient = preload("res://scripts/components/environment/day_night_system/sky_color_gradients/normal/normal_sky_top_color_gradient.tres")
@export var sky_horizon_color: Gradient = preload("res://scripts/components/environment/day_night_system/sky_color_gradients/normal/normal_sky_horizon_gradient.tres")
@export var sky_ground_color: Gradient = preload("res://scripts/components/environment/day_night_system/sky_color_gradients/normal/normal_sky_ground_gradient.tres")
