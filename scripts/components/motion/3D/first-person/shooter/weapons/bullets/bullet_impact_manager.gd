...
const BulletHoleNormal: PackedScene = preload("res://scripts/components/motion/3D/first-person/shooter/weapons/bullets/decals/scenes/bullet_normal_decal.tscn")
const BulletHoleMetal: PackedScene = preload("res://scripts/components/motion/3D/first-person/shooter/weapons/bullets/decals/scenes/bullet_metal_decal.tscn")
const BulletHoleBlood: PackedScene = preload("res://scripts/components/motion/3D/first-person/shooter/weapons/bullets/decals/scenes/bullet_blood_decal.tscn")
#endregion

#region Impact scenes
const BulletBloodImpact: PackedScene = preload("res://scripts/components/motion/3D/first-person/shooter/weapons/bullets/impact/scenes/bullet_blood_impact.tscn")
const BulletSmokeImpact: PackedScene = preload("res://scripts/components/motion/3D/first-person/shooter/weapons/bullets/impact/scenes/bullet_impact_smoke.tscn")
#endregion

#region Splatter scenes
const BloodSplatter: PackedScene = preload("res://scripts/components/motion/3D/first-person/shooter/weapons/bullets/decals/scenes/splatters/blood_splatter.tscn")
